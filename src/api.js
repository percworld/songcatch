const url = "https://www.phantasytour.com/api";
...
const getBands = () => {
    return fetch(`${url}/bands?%24orderby=followerCount+desc%2C+name&%24top=28`)
        .then(checkResponse)
}

const getSongs = (id) => {
    return fetch(`${url}/songs/?bandId=${id}`)
        .then(checkResponse)
}
